...
echo kwawingu_tours_render_booking_form( $kwawingu_tours_attrs, $kwawingu_tours_content ); // phpcs:ignore WordPress.Security.EscapeOutput -- render fn returns escaped HTML.
