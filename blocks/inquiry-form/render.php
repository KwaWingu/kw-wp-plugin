...
echo kwawingu_tours_render_inquiry_form( $kwawingu_tours_attrs, $kwawingu_tours_content ); // phpcs:ignore WordPress.Security.EscapeOutput -- render fn returns escaped HTML.
