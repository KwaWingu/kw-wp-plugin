<?php
/**
 * Starter-site page importer for KwaWingu Tours.
 *
...
class Importer {
	 ...
	 *
	 * @return array{created:array<int,int>,front:int} Summary of created page IDs and the front-page ID.
	 */
	 ...
	 * @return string Pattern content markup, or empty string if not registered.
	 */
